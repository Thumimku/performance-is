...
TRUNCATE TABLE IDN_OAUTH2_REFRESH_TOKEN;
TRUNCATE TABLE IDN_OAUTH2_REFRESH_TOKEN_SCOPE;
TRUNCATE TABLE IDN_OAUTH2_REVOKED_TOKENS;
TRUNCATE TABLE IDN_SUBJECT_ENTITY_REVOKED_EVENT;
